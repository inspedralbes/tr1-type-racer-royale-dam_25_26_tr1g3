...
const exercicis = [
  ...
  { nom: 'sentadillas', label: 'Esquatx', imatge: new URL('@/assets/sentadilla.jpg', import.meta.url).href },
  { nom: 'saltos', label: 'Saltar', imatge: new URL('@/assets/saltos.jpg', import.meta.url).href },
